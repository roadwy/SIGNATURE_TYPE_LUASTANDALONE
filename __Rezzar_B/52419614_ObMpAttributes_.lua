...
-- Command line: /mnt/d/out/__Rezzar_B/52419614_ObMpAttributes_ 
...
local l_0_5 = (string.lower)((mp.ContextualExpandEnvironmentVariables)("%systemroot%"))
...
local l_0_7 = (string.lower)((mp.ContextualExpandEnvironmentVariables)("%programfiles(x86)%"))
