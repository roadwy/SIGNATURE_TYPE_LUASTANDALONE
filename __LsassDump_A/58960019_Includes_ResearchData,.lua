...
-- Command line: /mnt/d/out/__LsassDump_A/58960019_Includes_ResearchData, 

-- params : ...
-- function num : 0
local l_0_0 = (mp.get_contextdata)(mp.CONTEXT_DATA_SCANREASON)
if l_0_0 ~= mp.SCANREASON_ONWRITE and l_0_0 ~= mp.SCANREASON_ONMODIFIEDHANDLECLOSE then
  return mp.CLEAN
end
...
do
  ...
  do
    ...
    if l_0_16 < 30720000 or l_0_16 > 102400000 then
      return mp.CLEAN
    end
