...
if L0_0 == L1_1 then
  ...
  if L1_1 and L2_2 then
    ...
    if L4_4 ~= nil and pcall(mp.get_contextdata, mp.CONTEXT_DATA_AMSI_CONTENTNAME) == nil then
      ...
      if (string.find(L4_4, "-encodedecommand", 1, true) ~= nil or string.find(L4_4, "-enc", 1, true) ~= nil) and (string.find(L4_4, "-noprofile", 1, true) ~= nil or string.find(L4_4, "-nop", 1, true) ~= nil) and (string.find(L4_4, "-noninteractive", 1, true) ~= nil or string.find(L4_4, "-noni", 1, true) ~= nil) then
