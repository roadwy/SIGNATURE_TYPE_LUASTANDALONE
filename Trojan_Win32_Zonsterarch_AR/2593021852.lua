...
if mp.bitxor(mp.readu_u32(L0_0, 25), mp.readu_u32(L0_0, 65)) ~= 1668440380 then
  return mp.CLEAN
end
if mp.bitxor(mp.readu_u32(L0_0, 25), mp.readu_u32(L0_0, 69)) ~= 1702259048 then
  return mp.CLEAN
end
if mp.bitxor(mp.readu_u32(L0_0, 25), mp.readu_u32(L0_0, 73)) ~= 1046767967 then
  return mp.CLEAN
end
return mp.INFECTED
