...
-- Command line: /mnt/d/out/Rogue_Win32_Winwebsec/1048854257 
...
local l_0_0 = (mp.readfile)((pe.foffset_rva)(pehdr.AddressOfEntryPoint), 120)
if (mp.crc32)(-1, l_0_0, 1, 120) ~= 2882220958 then
  return mp.CLEAN
end
return mp.INFECTED
