...
-- Command line: /mnt/d/out/_InfrastructureShared/LuaFuncHelper 
...
deepCopy = function(l_12_0, l_12_1)
  -- function num : 0_11
  if not l_12_1 then
    l_12_1 = {}
  end
  ...
  if type(l_12_0) == "table" then
    if l_12_1[l_12_0] then
      l_12_2 = l_12_1[l_12_0]
    else
      l_12_2 = {}
      l_12_1[l_12_0] = l_12_2
      for l_12_6,l_12_7 in next do
        local l_12_8 = deepCopy(l_12_6, l_12_1)
        l_12_2[l_12_8] = deepCopy(l_12_7, l_12_1)
      end
    end
  else
    do
...
UpdateScalarCounter = function(l_13_0, l_13_1)
  -- function num : 0_12
  do
    if (MpCommon.GetPersistContextNoPath)(l_13_0) == nil then
      local l_13_2 = 0
    end
    -- DECOMPILER ERROR at PC8: Confused about usage of register: R2 in 'UnsetPending'

    if type(l_13_2) ~= "number" then
      local l_13_3 = 0 + l_13_1
      local l_13_4 = MpCommon.OverwritePersistContextNoPath
      local l_13_5 = l_13_0
      local l_13_6 = {}
...
table_unpack = function(l_15_0, l_15_1)
  -- function num : 0_14
  if not l_15_1 then
    l_15_1 = 1
  end
  if l_15_0[l_15_1] ~= nil then
    return l_15_0[l_15_1], table_unpack(l_15_0, l_15_1 + 1)
  end
end

json_encode = function(l_16_0, l_16_1)
  -- function num : 0_15
  if l_16_1 == nil then
    l_16_1 = true
  end
  return encode_json_worker(l_16_0, l_16_1)
end

escapeChar4Json = function(l_17_0)
  -- function num : 0_16
  local l_17_1 = {}
  l_17_1["\\"] = "\\\\"
  l_17_1["\""] = "\\\""
  ...
  l_17_1["\r"] = "\\r"
  l_17_1["\t"] = "\\t"
  if not l_17_1[l_17_0] then
    return (string.format)("\\u%04x", l_17_0:byte())
  end
end

encodeString4Json = function(l_18_0)
  -- function num : 0_17
  return "\"" .. (string.gsub)(l_18_0, "[%z\001-\031\\\"]", escapeChar4Json) .. "\""
end

encodeNumber4Json = function(l_19_0)
  -- function num : 0_18
  local l_19_1 = string.format
  local l_19_2 = "%.14g"
  do
    local l_19_3 = l_19_0
    do return l_19_1(l_19_2, l_19_3) end
    -- DECOMPILER ERROR at PC6: Confused about usage of register R2 for local variables in 'ReleaseLocals'

  end
end

encodeScalar4Json = function(l_20_0)
  -- function num : 0_19
  if l_20_0 == nil then
    return "null"
  end
  local l_20_1 = {}
  l_20_1.string = encodeString4Json
  l_20_1.number = encodeNumber4Json
  l_20_1.boolean = tostring
  l_20_1["function"] = tostring
  local l_20_2 = type(l_20_0)
  do
    local l_20_3, l_20_4 = l_20_1[l_20_2] or tostring
    -- DECOMPILER ERROR at PC20: Confused about usage of register: R3 in 'UnsetPending'

    local l_20_5 = nil
    local l_20_6 = l_20_3
    do return l_20_6(l_20_0) end
    -- DECOMPILER ERROR at PC24: Confused about usage of register R4 for local variables in 'ReleaseLocals'

  end
end

encode_json_worker = function(l_21_0, l_21_1, l_21_2, l_21_3)
  -- function num : 0_20
  if l_21_0 == nil then
    return "null"
  end
  ...
  if l_21_2[l_21_0] then
    l_21_4 = l_21_4 .. "\"circular reference\""
  end
  l_21_2[l_21_0] = true
  do
    local l_21_5 = l_21_1 and "" or "\r\n"
    local l_21_6 = nil
    if type(l_21_0) == "table" then
      local l_21_7 = nil
      do
        local l_21_8, l_21_9 = "", l_21_1 and "" or "  "
        local l_21_10 = nil
        local l_21_11 = nil
        -- DECOMPILER ERROR at PC46: Overwrote pending register: R9 in 'AssignReg'

        do
          if ((l_21_3 or not l_21_1) and not l_21_1) or not 0 then
            local l_21_12, l_21_18 = , 0
          end
          -- DECOMPILER ERROR at PC79: Overwrote pending register: R4 in 'AssignReg'

          if rawget(l_21_0, 1) ~= nil or next(l_21_0) == nil then
            if l_21_3 == 0 then
              for l_21_16,l_21_17 in ipairs(l_21_0) do
                local l_21_13, l_21_14, l_21_15 = , maxKeyLength(l_21_0) + 3
              ...
              if ((not l_21_1 or not "") and type(R16_PC96) ~= "table") or rawget(R16_PC96, 1) ~= nil or next(R16_PC96) ~= nil or l_21_3 == 0 then
                do
                  for l_21_22,l_21_23 in pairs(l_21_0) do
                    local l_21_19, l_21_20, l_21_21 = nil
...
is_numeric = function(l_22_0)
  -- function num : 0_21
  if tonumber(l_22_0) ~= nil then
    return true
  end
  return false
end

is_boolean = function(l_23_0)
  -- function num : 0_22
  if tobool(l_23_0) ~= nil then
    return true
  end
  return false
end

tobool = function(l_24_0)
  -- function num : 0_23
  if type(l_24_0) == "bool" then
    return l_24_0
  end
  if type(l_24_0) == "string" then
    if l_24_0 == "true" then
      return true
    end
...
math_ln = function(l_25_0)
  ...
  return nil + l_25_1 * 69314718 / 100000000
end

math_log2 = function(l_26_0)
  -- function num : 0_25
  return math_ln(l_26_0) / math_ln(2)
end

math_pow = function(l_27_0, l_27_1)
  -- function num : 0_26
  local l_27_2 = 1
  for l_27_6 = 1, l_27_1 do
    l_27_2 = l_27_2 * l_27_0
  end
  return l_27_2
end

math_base = function(l_28_0, l_28_1)
  -- function num : 0_27
  local l_28_2 = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"
  local l_28_3 = ""
  while l_28_0 > 0 do
    l_28_3 = (string.char)((string.byte)(l_28_2, l_28_0 % l_28_1 + 1)) .. l_28_3
    l_28_0 = math_floor(l_28_0 / l_28_1)
  end
  return l_28_3
end

math_abs = function(l_29_0)
  -- function num : 0_28
  if l_29_0 < 0 then
    return -l_29_0
  else
...
math_floor = function(l_32_0)
  -- function num : 0_31
  do
    if l_32_0 < tonumber((string.format)("%.f", l_32_0)) then
      local l_32_1 = tonumber((string.format)("%.f", l_32_0)) - 1
    end
    -- DECOMPILER ERROR at PC10: Confused about usage of register: R1 in 'UnsetPending'
...
math_modf = function(l_33_0)
  -- function num : 0_32
  local l_33_1 = math_round(l_33_0 / 10)
  local l_33_2 = l_33_0 - l_33_1
  return l_33_1, l_33_2
end

math_ceil = function(l_34_0)
  -- function num : 0_33
  do
    if tonumber((string.format)("%.f", l_34_0)) < l_34_0 then
      local l_34_1 = tonumber((string.format)("%.f", l_34_0)) + 1
    end
    -- DECOMPILER ERROR at PC10: Confused about usage of register: R1 in 'UnsetPending'
...
math_round = function(l_35_0, l_35_1)
  -- function num : 0_34
  if not l_35_1 then
    l_35_1 = 0
  end
  local l_35_2 = tonumber
  do
    local l_35_3, l_35_4, l_35_5, l_35_6 = (string.format)("%." .. l_35_1 .. "f", l_35_0), .end
    do return l_35_2(l_35_3, l_35_4, l_35_5, l_35_6) end
...
math_sqrt_int = function(l_37_0)
  -- function num : 0_36
  local l_37_1 = 0
  if l_37_0 >= 0 and l_37_0 < 1 then
    l_37_1 = 0
  else
    if l_37_0 >= 1 and l_37_0 < 2 then
      l_37_1 = 1
    else
      if l_37_0 >= 2 and l_37_0 < 6 then
        l_37_1 = 2
      else
        if l_37_0 >= 6 and l_37_0 < 12 then
          l_37_1 = 3
        else
          if l_37_0 >= 12 and l_37_0 < 20 then
            l_37_1 = 4
          else
            if l_37_0 >= 20 and l_37_0 < 30 then
              l_37_1 = 5
            else
              if l_37_0 >= 30 and l_37_0 < 42 then
                l_37_1 = 6
              else
                if l_37_0 >= 42 and l_37_0 < 56 then
                  l_37_1 = 7
                else
                  if l_37_0 >= 56 and l_37_0 < 72 then
                    l_37_1 = 8
                  else
                    if l_37_0 >= 72 and l_37_0 < 90 then
                      l_37_1 = 9
                    else
                      if l_37_0 >= 90 and l_37_0 < 110 then
                        l_37_1 = 10
                      else
                        if l_37_0 >= 110 and l_37_0 < 132 then
                          l_37_1 = 11
                        else
                          if l_37_0 >= 132 and l_37_0 < 156 then
                            l_37_1 = 12
                          else
                            if l_37_0 >= 156 and l_37_0 < 182 then
                              l_37_1 = 13
                            else
                              if l_37_0 >= 182 and l_37_0 < 210 then
                                l_37_1 = 14
                              else
                                if l_37_0 >= 210 and l_37_0 < 240 then
                                  l_37_1 = 15
                                else
                                  if l_37_0 >= 240 and l_37_0 < 272 then
                                    l_37_1 = 16
                                  else
                                    if l_37_0 >= 272 and l_37_0 < 306 then
                                      l_37_1 = 17
                                    else
                                      if l_37_0 >= 306 and l_37_0 < 342 then
                                        l_37_1 = 18
                                      else
                                        if l_37_0 >= 342 and l_37_0 < 380 then
                                          l_37_1 = 19
                                        else
                                          if l_37_0 >= 380 and l_37_0 < 420 then
                                            l_37_1 = 20
                                          end
                                        end
                                      end
...
parseInt = function(l_38_0)
  -- function num : 0_37
  local l_38_3, l_38_4, l_38_5, l_38_6, l_38_7, l_38_8, l_38_9 = nil
  if type(l_38_0) ~= "string" then
    local l_38_1 = tonumber
    local l_38_2 = l_38_0
    do return l_38_1(l_38_2) end
    -- DECOMPILER ERROR at PC9: Confused about usage of register R2 for local variables in 'ReleaseLocals'

  end
  local l_38_10 = nil
  for l_38_14 = l_38_10, #l_38_0 do
    local l_38_14 = nil
    -- DECOMPILER ERROR at PC21: Overwrote pending register: R6 in 'AssignReg'

  end
  do return 0 + l_38_14 end
  -- DECOMPILER ERROR at PC25: Confused about usage of register R2 for local variables in 'ReleaseLocals'

end

fromhex = function(l_39_0)
  -- function num : 0_38
  return l_39_0:gsub("..", function(l_40_0)
    -- function num : 0_38_0
    local l_40_1 = string.char
    do
      local l_40_2, l_40_3, l_40_4 = tonumber(l_40_0, 16), .end
      do return l_40_1(l_40_2, l_40_3, l_40_4) end
...
tohex = function(l_40_0)
  -- function num : 0_39
  return l_40_0:gsub(".", function(l_41_0)
    -- function num : 0_39_0
    local l_41_1 = string.format
    local l_41_2 = "%02X"
    do
      local l_41_3, l_41_4 = (string.byte)(l_41_0), .end
      do return l_41_1(l_41_2, l_41_3, l_41_4) end
      -- DECOMPILER ERROR at PC9: Confused about usage of register R2 for local variables in 'ReleaseLocals'
...
euclideanDistance = function(l_41_0, l_41_1)
  -- function num : 0_40
  return math_sqrt_int(math_pow(math_abs(l_41_0[1] - l_41_1[1]), 2) + math_pow(math_abs(l_41_0[2] - l_41_1[2]), 2))
end

lastIndexOf = function(l_42_0, l_42_1, l_42_2)
  -- function num : 0_41
  local l_42_3 = -1
  do
    local l_42_4 = 0
    repeat
      if l_42_4 and l_42_2 <= l_42_4 then
        break
      end
    until l_42_4 == nil
    do return l_42_3 end
    -- WARNING: undefined locals caused missing assignments!
  end
end

lastIndexOfChar = function(l_43_0, l_43_1)
  -- function num : 0_42
  ...
  for l_43_5 = #l_43_0, 1, -1 do
    if (string.char)((string.byte)(l_43_0, l_43_5)) == l_43_1 then
      return l_43_5
    end
  end
  return -1
...
split = function(l_44_0, l_44_1, l_44_2)
  -- function num : 0_43
  if not l_44_0 then
    return l_44_2
  end
  ...
  do return l_44_2 end
  -- WARNING: undefined locals caused missing assignments!
end

kvsplit = function(l_45_0, l_45_1, l_45_2, l_45_3)
  -- function num : 0_44
  if not l_45_0 then
    return l_45_2
  end
  ...
  local l_45_4, l_45_5 = (string.find)(l_45_0, l_45_1)
  local l_45_6 = (string.sub)(l_45_0, 1, l_45_4 - 1)
  local l_45_7 = (string.sub)(l_45_0, l_45_5 + 1)
  local l_45_8 = tonumber(l_45_7)
  if l_45_8 then
    l_45_7 = l_45_8
  end
  if l_45_3 then
    l_45_7 = l_45_3(l_45_6, l_45_7)
  end
  l_45_2[l_45_6] = l_45_7
  return l_45_2
end

getLevenshteinDistance = function(l_46_0, l_46_1)
  -- function num : 0_45
  local l_46_2 = #l_46_0 + 1
  local l_46_3 = #l_46_1 + 1
  local l_46_4 = {}
  if l_46_2 == 0 then
    return l_46_3
  else
    if l_46_3 == 0 then
      ...
      if l_46_0 == l_46_1 then
        return 0
      end
    end
  end
  for l_46_8 = 0, l_46_2 do
    l_46_4[l_46_8] = {}
    -- DECOMPILER ERROR at PC24: Confused about usage of register: R9 in 'UnsetPending'

    ;
    (l_46_4[l_46_8])[0] = l_46_8
  end
  for l_46_12 = 0, l_46_3 do
    -- DECOMPILER ERROR at PC31: Confused about usage of register: R9 in 'UnsetPending'

    (l_46_4[0])[l_46_12] = l_46_12
  end
  for l_46_16 = 1, l_46_2 do
    for l_46_20 = 1, l_46_3 do
      -- DECOMPILER ERROR at PC54: Confused about usage of register: R13 in 'UnsetPending'

      if l_46_0:byte(l_46_16) == l_46_1:byte(l_46_20) then
        (l_46_4[l_46_16])[l_46_20] = (l_46_4[l_46_16 - 1])[l_46_20 - 1]
      else
        -- DECOMPILER ERROR at PC70: Confused about usage of register: R13 in 'UnsetPending'

        ;
        (l_46_4[l_46_16])[l_46_20] = math_min((l_46_4[l_46_16 - 1])[l_46_20], (l_46_4[l_46_16])[l_46_20 - 1], (l_46_4[l_46_16 - 1])[l_46_20 - 1]) + 1
      end
    end
  end
  return (l_46_4[l_46_2])[l_46_3]
end

getHammingDistance = function(l_47_0, l_47_1)
  -- function num : 0_46
  local l_47_2 = 0
  for l_47_6 = 0, math_min(#l_47_0, #l_47_1) do
    if l_47_0:sub(l_47_6, l_47_6) ~= l_47_1:sub(l_47_6, l_47_6) then
      l_47_2 = l_47_2 + 1
    end
  end
  return l_47_2
...
explode = function(l_48_0, l_48_1)
  -- function num : 0_47
  local l_48_2 = str_split
  local l_48_3 = l_48_0
  do
    local l_48_4 = l_48_1
    do return l_48_2(l_48_3, l_48_4) end
    -- DECOMPILER ERROR at PC5: Confused about usage of register R3 for local variables in 'ReleaseLocals'

  end
end

str_split = function(l_49_0, l_49_1)
  -- function num : 0_48
  local l_49_2 = {}
  local l_49_3 = string.format
  local l_49_4 = "[%s]"
  do
    l_49_3 = l_49_3(l_49_4, l_49_1 or "%s")
    l_49_4 = 1
    while 1 do
      if not l_49_0:find(l_49_3, l_49_4) then
        do
          local l_49_6 = nil
          l_49_2[#l_49_2 + 1] = l_49_0:sub(l_49_4)
          do break end
          do
            local l_49_7 = nil
            l_49_2[#l_49_2 + 1] = l_49_0:sub(l_49_4, l_49_7 - 1)
            l_49_4 = l_49_7 + 1
    ...
    do return l_49_2 end
    -- DECOMPILER ERROR at PC32: freeLocal<0 in 'ReleaseLocals'

  end
end

StringEndsWith = function(l_50_0, l_50_1)
  -- function num : 0_49
  if not l_50_0 or not l_50_1 then
    return false
  end
  if #l_50_0 < #l_50_1 then
    return false
  end
  do return l_50_1 == "" or (string.sub)(l_50_0, -(string.len)(l_50_1)) == l_50_1 end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

StringStartsWith = function(l_51_0, l_51_1)
  -- function num : 0_50
  do return l_51_1 == "" or (string.sub)(l_51_0, 1, (string.len)(l_51_1)) == l_51_1 end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

StringSplit = function(l_52_0, l_52_1)
  -- function num : 0_51
  if l_52_1 == nil then
    l_52_1 = "%s"
  end
  local l_52_2 = {}
  for l_52_6 in (string.gmatch)(l_52_0, "([^" .. l_52_1 .. "]+)") do
    (table.insert)(l_52_2, l_52_6)
  end
  return l_52_2
end

str_pad = function(l_53_0, l_53_1, l_53_2, l_53_3)
  -- function num : 0_52
  local l_53_4 = 1
  local l_53_5 = 2
  local l_53_6 = 3
  if type(l_53_0) ~= "string" then
    l_53_0 = tostring(l_53_0)
  end
  if not l_53_2 then
    l_53_2 = " "
  end
  ...
  if l_53_1 < #l_53_0 then
    return l_53_0
  else
    local l_53_7 = l_53_1 - #l_53_0
    if l_53_3 == l_53_6 then
      local l_53_8 = ""
      local l_53_9 = ""
      local l_53_10 = math_floor(l_53_7 / 2)
      l_53_8 = str_repeat_to_length(l_53_2, l_53_10)
      l_53_9 = str_repeat_to_length(l_53_2, l_53_10 + l_53_7 % 2)
      return l_53_8 .. l_53_0 .. l_53_9
    else
      do
        if l_53_3 == l_53_5 then
          local l_53_11 = str_repeat_to_length(l_53_2, l_53_7)
          return l_53_11 .. l_53_0
        else
          do
            do
              local l_53_12 = str_repeat_to_length(l_53_2, l_53_7)
              do return l_53_0 .. l_53_12 end
              do return l_53_0 end
            end
          end
        end
      end
...
trim = function(l_54_0, l_54_1)
  ...
  do
    local l_54_5 = ltrim
    l_54_5 = l_54_5(l_54_0, l_54_1)
    local l_54_3 = nil
    l_54_3 = l_54_1
    local l_54_4 = nil
    do return l_54_2(l_54_5, l_54_3) end
    -- DECOMPILER ERROR at PC11: Confused about usage of register R3 for local variables in 'ReleaseLocals'

  end
end

ltrim = function(l_55_0, l_55_1)
  -- function num : 0_54
  if not l_55_1 then
    l_55_1 = " "
  end
  local l_55_2 = string.gsub
  local l_55_3 = l_55_0
  do
    local l_55_6 = "^(["
    l_55_6 = l_55_6 .. l_55_1 .. "]+)"
    local l_55_4 = nil
    l_55_4 = ""
    local l_55_5 = nil
    do return l_55_2(l_55_3, l_55_6, l_55_4) end
    -- DECOMPILER ERROR at PC13: Confused about usage of register R3 for local variables in 'ReleaseLocals'

  end
end

rtrim = function(l_56_0, l_56_1)
  -- function num : 0_55
  if not l_56_1 then
    l_56_1 = " "
  end
  local l_56_2 = string.gsub
  local l_56_3 = l_56_0
  do
    local l_56_6 = "(["
    ...
    l_56_4 = ""
    local l_56_5 = nil
    do return l_56_2(l_56_3, l_56_6, l_56_4) end
    -- DECOMPILER ERROR at PC13: Confused about usage of register R3 for local variables in 'ReleaseLocals'

  end
end

addPadding = function(l_57_0, l_57_1)
  -- function num : 0_56
  if type(l_57_0) ~= "string" then
    l_57_0 = tostring(l_57_0)
  end
  if l_57_1 < #l_57_0 then
    return l_57_0
  else
    local l_57_2 = str_repeat(" ", l_57_1 - #l_57_0)
    return l_57_0 .. l_57_2
  end
end

maxKeyLength = function(l_58_0)
  -- function num : 0_57
  local l_58_1 = 0
  for l_58_5,l_58_6 in pairs(l_58_0) do
    if type(l_58_5) == "number" then
      l_58_5 = tostring(l_58_5)
    end
    if l_58_1 < #l_58_5 then
      l_58_1 = #l_58_5
    end
  end
  return l_58_1
