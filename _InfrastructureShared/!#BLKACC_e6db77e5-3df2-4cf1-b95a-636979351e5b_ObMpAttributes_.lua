...
if L0_0 and mp.IsPathExcludedForHipsRule(L1_1, "e6db77e5-3df2-4cf1-b95a-636979351e5b") then
  return mp.CLEAN
end
if string.find(L1_1, "%a:\\sccm_cache\\prestg\\[%d%.]+\\microsoft%-corporation_postoobe\\.+%.ps1$") ~= nil then
  return mp.CLEAN
end
return mp.INFECTED
