...
if L0_0 then
  ...
  if string.find(L0_0, "\\program files", 1, true) or string.find(L0_0, "\\steam", 1, true) or string.find(L0_0, "\\langrisser", 1, true) or string.find(L0_0, "\\hearthstone", 1, true) or string.find(L0_0, "\\com3d2", 1, true) or string.find(L0_0, "\\cm3d2", 1, true) or string.find(L0_0, "\\overwolf", 1, true) or string.find(L0_0, "\\subnautica", 1, true) or string.find(L0_0, "\\ngen", 1, true) or string.find(L0_0, "\\program\\revit", 1, true) or string.find(L0_0, "\\lenovo", 1, true) or string.find(L0_0, "\\opera\\", 1, true) or string.find(L0_0, "\\application\\chrome", 1, true) or string.find(L0_0, "\\syswow64\\msiexec", 1, true) or string.find(L0_0, "\\application\\browser", 1, true) or string.find(L0_0, "\\onedrive\\", 1, true) or string.find(L0_0, "\\twitch\\", 1, true) or string.find(L0_0, "\\coherentui", 1, true) or string.find(L0_0, "game", 1, true) then
    return mp.CLEAN
  end
end
