...
if L2_2 and L3_3 then
  ...
  if L4_4 then
    ...
    L6_6 = {}
    L6_6.SIG_CONTEXT = "BM"
    L6_6.CONTENT_SOURCE = "IRL_ALLOCVMREMOTE_SETTHREADCONTEXT"
    L7_7 = string
    L7_7 = L7_7.match
    L8_8 = L5_5
    L9_9 = "^https?://"
        ...
        if L10_10 == 2 then
          ...
          if L10_10 >= 60 then
            ...
            if L14_14 then
              ...
              L22_22 = {}
              L22_22.product_version = L20_20
              L22_22.file_version = L21_21
              L22_22.arch_str = L15_15
              L22_22.sizeof_shellcode = L13_13
              L22_22.medicated_process_path = L3_3
              L22_22.address_of_shellcode = L11_11
              L22_22.dest_url = L5_5
              bm.set_detection_string(safeJsonSerialize(L22_22))
