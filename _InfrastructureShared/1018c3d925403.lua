...
if L0_0(mp.bitor(mp.bitor(mp.FILEPATH_QUERY_FNAME, mp.FILEPATH_QUERY_PATH), mp.FILEPATH_QUERY_LOWERCASE)) ~= "tcpdump" or string.find(L0_0, "^/tmp") or string.find(L0_0, "^/var") or string.find(L0_0, "^/home") then
  return mp.INFECTED
end
return mp.CLEAN
