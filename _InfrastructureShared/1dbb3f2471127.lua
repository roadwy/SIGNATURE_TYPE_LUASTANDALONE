...
-- Command line: /mnt/d/out/_InfrastructureShared/1dbb3f2471127 
...
if (this_sigattrlog[6]).matched then
  ...
  do
    ...
    -- DECOMPILER ERROR at PC179: Confused about usage of register R7 for local variables in 'ReleaseLocals'
