...
-- Command line: /mnt/d/out/_InfrastructureShared/!#Lua_Heaple_Includes_SetAttributeF 

-- params : ...
-- function num : 0
local l_0_0 = (mp.get_mpattributevalue)("RPF:MsilMetadataClassifier.Probability")
do
  do
