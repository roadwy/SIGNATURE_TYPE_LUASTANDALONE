...
-- Command line: /mnt/d/out/_InfrastructureShared/212b35b621884_Includes_TechniqueTracker,BMLuaLib 
                    ...
                    do
                      ...
                      do
                        ...
                        if (sysio.IsFileExists)(l_0_43) and (string.find)(l_0_44, ">", 1, true) and ((string.find)(l_0_44, l_0_43, 1, true) or "/var/mail/" .. (string.match)(l_0_38, "/var/spool/mail/([^;]*)") == nil or "/var/mail/" .. (string.match)(l_0_38, "/var/spool/mail/([^;]*)") == l_0_43) and (bm.GetSignatureMatchDuration)() < 20000000 then
                          if l_0_41 ~= nil then
                            TrackPidAndTechnique(l_0_41, "T1070.002", "DefenseEvasion")
                          end
                          ...
                          if l_0_42 ~= nil then
                            TrackPidAndTechnique(l_0_42, "T1070.002", "DefenseEvasion")
                          end
                          addRelatedProcess()
