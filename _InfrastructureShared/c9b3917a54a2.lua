...
-- Command line: /mnt/d/out/_InfrastructureShared/c9b3917a54a2 
...
local l_0_1 = (mp.ContextualExpandEnvironmentVariables)("%programfiles(x86)%")
if l_0_1 == nil or l_0_1 == "" then
  return mp.CLEAN
end
local l_0_2 = (mp.ContextualExpandEnvironmentVariables)("%programfiles%")
...
local l_0_5 = (mp.ContextualExpandEnvironmentVariables)("%windir%")
