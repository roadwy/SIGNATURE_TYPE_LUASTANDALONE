    ...
    if L0_0 then
      ...
      for L7_7, L8_8 in L4_4(L5_5) do
        ...
        if L10_10 == L11_11 then
          ...
          if L10_10 then
            L10_10 = IsKeyInRollingQueue
            L11_11 = "SuspExeFileDroppedViaSMB"
            L12_12 = L9_9
            L10_10 = L10_10(L11_11, L12_12, true)
            if L10_10 then
              L11_11 = bm
              ...
              for _FORV_16_, _FORV_17_ in ipairs(L12_12) do
                if _FORV_17_.reason == bm.RELATIONSHIP_CREATED then
                  ...
                  TrackPidAndTechniqueBM(_FORV_17_.ppid, "T1021.002", "remoteservice_created_a")
                end
              end
              mp.ReportLowfi(L9_9, 3598935839)
              bm.add_related_file(L9_9)
              TrackPidAndTechniqueBM(L8_8.ppid, "T1021.002", "remoteservice_svc_a")
              return mp.INFECTED
            end
          end
        end
