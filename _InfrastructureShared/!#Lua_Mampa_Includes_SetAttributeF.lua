...
-- Command line: /mnt/d/out/_InfrastructureShared/!#Lua_Mampa_Includes_SetAttributeF 

-- params : ...
-- function num : 0
local l_0_0 = (mp.get_mpattributevalue)("RPF:Mampa:Probability")
do
  do
    if l_0_0 ~= nil and l_0_0 <= 100 then
      local l_0_1 = {}
