...
L1_1 = L1_1.find
L2_2 = L0_0
L3_3 = "%.downloadstring%(%'?\"?https?%://(%d+%.%d+%.%d+%.%d+)%:%d+/%w+"
L3_3 = L1_1(L2_2, L3_3)
if not L3_3 then
  L4_4 = mp
  L4_4 = L4_4.CLEAN
...
L4_4 = L4_4.find
L5_5 = L0_0
L6_6 = "%.downloadstring%(%'?\"?(https?%://%d+%.%d+%.%d+%.%d+%:%d+)/%w+"
L6_6 = L4_4(L5_5, L6_6)
if not L6_6 then
  L7_7 = mp
  L7_7 = L7_7.CLEAN
...
L7_7 = {}
L7_7.SIG_CONTEXT = "PSHELL"
L7_7.CONTENT_SOURCE = "POWERSHELL"
L7_7.PROCESS_CONTEXT = "POWERSHELL.EXE"
L7_7.FILELESS = "true"
L7_7.CMDLINE_URL = "true"
L7_7.BREAK_AT_FIRST_HIT_MALWARE = "40"
L7_7.TAG = "INTERFLOW"
