...
-- Command line: /mnt/d/out/_InfrastructureShared/709b388e2dc28 
                            ...
                            do
                              ...
                              do
                                ...
                                if l_0_15 ~= nil and (sysio.IsFileExists)(l_0_15) then
                                  ...
                                  if not (MpCommon.QueryPersistContext)(l_0_15, "SysintToolsCopyFileA") then
                                    (MpCommon.AppendPersistContext)(l_0_15, "SysintToolsCopyFileA", 0)
                                  end
                                end
                                return mp.INFECTED
                              end
