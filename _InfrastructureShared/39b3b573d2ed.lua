...
L4_4 = "HKLM\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Image File Execution Options\\displayswitch.exe"
L3_3 = L3_3(L4_4)
if L3_3 ~= nil then
  L4_4 = sysio
...
for _FORV_9_, _FORV_10_ in L6_6(L7_7) do
  if _FORV_10_.image_path ~= nil and string.find(string.lower(_FORV_10_.image_path), "winlogon.exe", 1, true) then
    return mp.INFECTED
  end
end
return L6_6
