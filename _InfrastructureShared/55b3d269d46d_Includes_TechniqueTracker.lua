...
if StringStartsWith(L4_4, "%") then
  return mp.CLEAN
end
if L1_1:match("spool\\drivers\\.+\\.+\\new\\(.*)") ~= nil and L4_4:match("spool\\drivers\\.+\\.+\\new\\(.*)") ~= nil and L1_1:match("spool\\drivers\\.+\\.+\\new\\(.*)") == L4_4:match("spool\\drivers\\.+\\.+\\new\\(.*)") and L0_0 < L3_3 then
  TrackPidAndTechniqueBM(L2_2, "susp_spoolhack", "priteshel_e")
  return mp.INFECTED
end
return mp.CLEAN
