...
-- Command line: /mnt/d/out/_InfrastructureShared/f9b3e6a734a8_Includes_BMLuaLib,Tech 
      ...
      if (sigattr_tail[(mp.crc32)(0, ((sigattr_tail[R7_PC40]).utf8p1):lower(), 1, #((sigattr_tail[R7_PC40]).utf8p1):lower())]).attribute == 16386 then
        ...
        if (l_0_1[(mp.crc32)(0, l_0_19, 1, #l_0_19)] ~= nil or l_0_1[l_0_20] ~= nil) and l_0_13[l_0_20] == nil then
          ...
          if l_0_18:match("%.[^/%.]+$") ~= nil and (mp.GetExtensionClass)(l_0_18:match("%.[^/%.]+$")) ~= 3 and #l_0_18 < #l_0_19 and l_0_19:find(l_0_18, 1, true) == 1 and l_0_19:byte(#l_0_18 + 1) ~= 58 then
            l_0_13[l_0_20] = 1
            local l_0_22 = nil
            if l_0_19:match("%.[^/%.]+$") ~= nil and (mp.GetExtensionClass)(l_0_19:match("%.[^/%.]+$")) ~= 4 and IsExcludedByImagePathFileExtension(l_0_2, l_0_19:match("%.[^/%.]+$")) == false and IsExcludedByImagePathFileExtensionRegEx(l_0_2, l_0_19:match("%.[^/%.]+$")) == false and IsExtensionDatePattern(l_0_19:match("%.[^/%.]+$")) == false then
              local l_0_23 = nil
              if l_0_12[(string.sub)(l_0_19, #l_0_18 + 1)] ~= nil then
                (table.insert)(l_0_12[(string.sub)(l_0_19, #l_0_18 + 1)], l_0_17)
                if #l_0_12[(string.sub)(l_0_19, #l_0_18 + 1)] >= 5 then
                  (bm.add_related_string)("ransom_extension", (string.sub)(l_0_19, #l_0_18 + 1), bm.RelatedStringBMReport)
                  local l_0_24 = nil
                  local l_0_25 = "genb_linux_ransom_meta"
                  ...
                  for l_0_29,l_0_30 in pairs(l_0_12[l_0_24]) do
                    local l_0_26 = {}
                    -- DECOMPILER ERROR at PC208: Confused about usage of register: R23 in 'UnsetPending'

                    ;
                    (bm.add_related_file)((sigattr_tail[R23_PC208]).utf8p1)
                    ;
                    (table.insert)(l_0_26, (sigattr_tail[R23_PC208]).utf8p1)
                  end
