...
if string.find(L1_1, "\\program files", 1, true) or string.find(L1_1, "\\netlogon\\", 1, true) or string.find(L1_1, "\\sysvol\\", 1, true) or string.find(L1_1, " -nologo ", 1, true) or string.find(L1_1, " -noprofile ", 1, true) or string.find(L1_1, " -noninteractive ", 1, true) or string.find(L1_1, "\\drv\\tools\\global\\proactiveagent\\scripts", 1, true) then
  return mp.CLEAN
end
