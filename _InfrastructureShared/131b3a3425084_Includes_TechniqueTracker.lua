...
if string.find(L0_0, "\\program files", 1, true) or string.find(L0_0, "\\corevision.terminal", 1, true) or string.find(L0_0, "machinelearning", 1, true) or string.find(L0_0, "emisweb.exe", 1, true) then
  return mp.CLEAN
end
