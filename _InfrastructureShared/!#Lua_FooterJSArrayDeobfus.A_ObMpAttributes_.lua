...
-- Command line: /mnt/d/out/_InfrastructureShared/!#Lua_FooterJSArrayDeobfus.A_ObMpAttributes_ 
...
do
  ...
  do
    ...
    ;
    (mp.vfo_add_buffer)(l_0_0, "[ftr-jsarr-deobfus]", mp.ADD_VFO_TAKE_ACTION_ON_DAD)
    return mp.INFECTED
  end
  return mp.CLEAN
end
