...
-- Command line: /mnt/d/out/_InfrastructureShared/1629b8c0ae19_Includes_ScriptLuaLib 

-- params : ...
-- function num : 0
if (mp.get_mpattribute)("//SCPT:HTML/DoubleCryptoFraudKey") == false and (mp.get_mpattribute)("//SCPT:MSG/CryptoExtortion") == false and (mp.get_mpattribute)("ALF:AGGR:SITE/CryptoExtort") == false then
  return mp.CLEAN
end
