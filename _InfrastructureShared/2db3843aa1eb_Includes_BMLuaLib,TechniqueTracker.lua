...
-- Command line: /mnt/d/out/_InfrastructureShared/2db3843aa1eb_Includes_BMLuaLib,TechniqueTracker 
...
do
  ...
  if l_0_0 ~= nil and (versioning.GetCloudBlockLevel)() >= 4 then
    TrackPidAndTechniqueBM(l_0_0, "T1562.001", "DefenseEvasion_KptrRestrictToggle")
    ...
    for l_0_9,l_0_10 in ipairs(l_0_5) do
      ...
      TrackPidAndTechniqueBM(R7_PC30.ppid, "T1562.001", "DefenseEvasion_KptrRestrictToggle")
    end
    addRelatedProcess()
    reportRelatedBmHits()
    return mp.INFECTED
