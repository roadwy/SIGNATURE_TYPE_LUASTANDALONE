...
if L0_0 == L1_1 then
  ...
  L2_2 = "SCPT:JS/AsrobfusWscrExec.A"
  L1_1 = L1_1(L2_2)
  if L1_1 then
    L1_1 = pcall
    L2_2 = mp
        ...
        if L6_6 then
          ...
          if not L6_6 then
            ...
            if L6_6 then
              ...
              if string.find(L7_7, "wscript.shell", 1, true) == nil and string.find(L7_7, ".exec", 1, true) == nil then
                mp.ReportLowfi(L5_5, 204144969)
                return mp.INFECTED
              end
            end
          end
  ...
  if L2_2 then
    L2_2 = mp
    L2_2 = L2_2.get_mpattribute
    L3_3 = "SCPT:JS/AsrobfusWscrExec.C"
    L2_2 = L2_2(L3_3)
    if L2_2 then
      L2_2 = MpCommon
      L2_2 = L2_2.AppendPersistContext
