...
-- Command line: /mnt/d/out/_InfrastructureShared/a1b37daecfcb 
...
do
  ...
  do
    ...
    if (not (this_sigattrlog[5]).matched or (string.lower)((this_sigattrlog[5]).utf8p1) ~= nil) and ((string.match)((string.lower)((this_sigattrlog[5]).utf8p1), "\\microsoft\\exchange server\\v%d%d\\frontend\\") ~= nil or (string.find)((string.lower)((this_sigattrlog[5]).utf8p1), "\\frontend\\httpproxy\\owa\\", 1, true) ~= nil or (string.match)((string.lower)((this_sigattrlog[5]).utf8p1), "\\microsoft\\exchange server\\v%d%d\\clientaccess\\") ~= nil) then
