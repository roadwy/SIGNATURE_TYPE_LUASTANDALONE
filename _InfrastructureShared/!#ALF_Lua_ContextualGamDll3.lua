...
elseif L0_0 == L1_1 then
  ...
  if L4_4 then
    ...
    L7_7 = L7_7.readu_u32
    L7_7 = L7_7(L5_5, 1)
    if pe.mmap_rva(L7_7, 32):find("^%w+") and (string.lower(mp.get_contextdata(mp.CONTEXT_DATA_PROCESSNAME)) == "msiexec.exe" or string.lower(mp.get_contextdata(mp.CONTEXT_DATA_PROCESSNAME)) == "rundll32.exe") then
      return mp.INFECTED
    end
  end
end
