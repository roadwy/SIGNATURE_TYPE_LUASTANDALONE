...
-- Command line: /mnt/d/out/_InfrastructureShared/!#Lua_JSExcelSiorML_Includes_SetAttributeF 

-- params : ...
-- function num : 0
local l_0_0 = (mp.get_mpattributevalue)("RPF:ExcelSiorJS:Probability")
;
(mp.set_mpattribute)("Lua:ExcelSiorJSML:" .. l_0_0)
do
  do
