...
L2_2 = string.gsub(L2_2, "\"\"", "\"")
if string.match(L2_2, "/im[%s]*\"") then
  L3_3 = string.match(L2_2, "/im[%s]*\"([^\"]+)\"")
else
  L3_3 = string.match(L2_2, "/im[%s]*(%S+)")
end
if L3_3 == "" or L3_3 == nil then
  return mp.CLEAN
end
TrackPidAndTechnique(L0_0.ppid, "T1489", "task_kill_" .. L3_3)
if TT_IsProdCriticalService(L3_3) then
  TrackPidAndTechnique(L0_0.ppid, "T1489", "svc_stop_" .. L3_3)
