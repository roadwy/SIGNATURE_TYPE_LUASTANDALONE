...
function L0_0(A0_3)
  if string.find(A0_3, "kobdrvapi", 1, true) ~= nil then
    return false
  end
  if string.find(A0_3, "appxprovider", 1, true) ~= nil then
    return false
  end
  if string.find(A0_3, "dbghelp", 1, true) ~= nil then
    return false
  end
  return true
end
