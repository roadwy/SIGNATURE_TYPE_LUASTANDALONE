...
-- Command line: /mnt/d/out/_InfrastructureShared/1a4b3fe499283_Includes_TechniqueTracker 
                ...
                do
                  ...
                  do
                    ...
                    if l_0_11 ~= nil and (sysio.IsFileExists)(l_0_11) then
                      ...
                      ;
                      (MpCommon.AppendPersistContext)((string.lower)(l_0_11), "MasqSuspCopyTarget", 3600)
                      local l_0_26 = nil
                      -- DECOMPILER ERROR at PC148: Confused about usage of register: R1 in 'UnsetPending'

                      TrackFileAndTechnique(l_0_11, {"T1036.003:masquerading_target", "T1036.003:defenseevasion_target", "T1036.003:MasqSuspCopy.E"})
                    end
                    do
                      return mp.INFECTED
                    end
