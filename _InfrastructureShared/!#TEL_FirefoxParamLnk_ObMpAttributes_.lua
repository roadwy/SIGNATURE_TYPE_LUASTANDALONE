...
if string.sub(L1_1, 1, 19) == "mozilla firefox.lnk" and (L0_0:find("\\microsoft\\internet explorer\\quick launch", 1, true) ~= nil or string.sub(L0_0, -20) == "\\start menu\\programs" or string.sub(L0_0, -8) == "\\desktop") then
  return mp.INFECTED
end
return mp.CLEAN
