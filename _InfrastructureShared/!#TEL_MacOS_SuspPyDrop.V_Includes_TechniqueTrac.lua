...
elseif L5_5 == 1 then
  ...
  for L9_9, L10_10 in L6_6(L7_7) do
    ...
    if L11_11 then
      ...
      L11_11("BM_MacPyMasquerading")
      if L3_3 then
        L11_11 = MpCommon
        L11_11 = L11_11.BmTriggerSig
        L11_11(L3_3, "BM_MacPyMasquerading", L4_4)
    ...
    if string.match(L11_11, L10_10) then
      mp.set_mpattribute("BM_MacPyMasquerading")
      if L3_3 then
        MpCommon.BmTriggerSig(L3_3, "BM_MacPyMasquerading", L4_4)
