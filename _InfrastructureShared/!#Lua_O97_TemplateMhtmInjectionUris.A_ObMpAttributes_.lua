...
-- Command line: /mnt/d/out/_InfrastructureShared/!#Lua_O97_TemplateMhtmInjectionUris.A_ObMpAttributes_ 
...
if l_0_1:find("_rels/", 1, true) then
  local l_0_2 = nil
  local l_0_3 = 0
  local l_0_4 = ""
  ;
  ...
  for l_0_8 in l_0_2:gmatch("<Relationship %/?([%w:]+.-%/?)/>") do
    ...
    local l_0_10 = l_0_8:match("Target%S?=%S?\"mhtml%:%s?(http[^\"]+)")
