...
if string.sub(L0_0, -4) == ".exe" or string.sub(L0_0, -4) == ".tmp" or string.sub(L0_0, -5) == ".html" or string.sub(L0_0, -4) == ".hta" or L0_0:find("availabilitytest", 1, true) or L0_0:find("mxescr", 1, true) then
  return mp.CLEAN
end
if L0_0 ~= nil then
  ...
  if mp.get_mpattributesubstring("SWF/Obfuscator") then
  end
  ...
  if 0 + 1 + 2 + 1 + 1 + 2 + 2 + 1 + 2 + 2 + 2 + 2 + 2 + 1 + 1 + 1 + 2 >= 5 then
    return mp.INFECTED
  end
end
return mp.CLEAN
