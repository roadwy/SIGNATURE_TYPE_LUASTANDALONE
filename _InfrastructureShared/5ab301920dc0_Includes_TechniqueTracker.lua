...
-- Command line: /mnt/d/out/_InfrastructureShared/5ab301920dc0_Includes_TechniqueTracker 
  ...
  do
    ...
    do
      ...
      if l_0_5 ~= nil and (sysio.IsFileExists)(l_0_5) then
        ...
        TrackFileAndTechnique(l_0_5, {"T1036.003:masquerading_target", "T1036.003:defenseevasion_target", "T1036.003:MasqSuspCopy.D"})
      end
      do
        return mp.INFECTED
      end
