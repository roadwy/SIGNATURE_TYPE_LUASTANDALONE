...
-- Command line: /mnt/d/out/_InfrastructureShared/35b39d9c5a24_Includes_TechniqueTracker 
...
for l_0_6,l_0_7 in ipairs(l_0_2) do
  ...
  if l_0_8 == bm.RELATIONSHIP_INJECTION then
    TrackPidAndTechniqueBM(l_0_7.ppid, "T1055.002", "processinjection_target_d")
    ;
