...
-- Command line: /mnt/d/out/_InfrastructureShared/!#Lua_OLE.Shellcode.Custom_ObMpAttributes_ 
...
do
  if (string.find)(l_0_1, "по\017Ю║\177\026\225", 1, true) == nil or l_0_1 == nil then
    local l_0_4 = nil
