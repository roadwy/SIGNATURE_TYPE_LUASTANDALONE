...
-- Command line: /mnt/d/out/_InfrastructureShared/!#Lua_FilenameSimilarToWindowsFile.B_Includes_Path_ObMpAttr 
...
local l_0_7 = (mp.ContextualExpandEnvironmentVariables)("%windir%")
