...
-- Command line: /mnt/d/out/_InfrastructureShared/129b32742cf39_Includes_TechniqueTracker 
          ...
          do
            ...
            do
              ...
              if (this_sigattrlog[4]).utf8p2 ~= nil and (sysio.IsFileExists)((this_sigattrlog[4]).utf8p2) then
                ...
                ;
                (MpCommon.AppendPersistContext)((string.lower)((this_sigattrlog[4]).utf8p2), "MasqSuspCopyTarget", 3600)
                local l_0_27 = nil
                -- DECOMPILER ERROR at PC126: Confused about usage of register: R1 in 'UnsetPending'

                TrackFileAndTechnique((this_sigattrlog[4]).utf8p2, {"T1036.003:masquerading_target", "T1036.003:defenseevasion_target", "T1036.003:MasqSuspCopy.F"})
              end
              do
                return mp.INFECTED
              end
