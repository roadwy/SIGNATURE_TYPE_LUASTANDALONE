...
if L0_0 then
  ...
  if L0_0 then
    ...
    if L0_0 then
      ...
      L4_4 = string
      L4_4 = L4_4.match
      L4_4 = L4_4(L3_3, "Sistema indispon")
      if L4_4 ~= nil then
        L4_4 = mp
        L4_4 = L4_4.CLEAN
        return L4_4
...
if L0_0 then
  ...
  L4_4 = string
  L4_4 = L4_4.match
  L4_4 = L4_4(L3_3, "Este navegador n\227o possui o n\237vel de seguran\231a exigido pel")
  if L4_4 ~= nil then
    L4_4 = mp
    L4_4 = L4_4.CLEAN
    return L4_4
  ...
  L4_4 = decryptSub
  L4_4 = L4_4(L3_3)
  if string.match(L4_4, "Este navegador n\227o possui o n\237vel de seguran\231a exigido pel") ~= nil then
    return mp.INFECTED
  end
end
L0_0 = mp
