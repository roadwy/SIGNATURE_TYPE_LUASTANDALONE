...
-- Command line: /mnt/d/out/_InfrastructureShared/56b32b1f542b_Includes_TechniqueTracker 
  ...
  do
    ...
    do
      ...
      if l_0_5 ~= nil and (sysio.IsFileExists)(l_0_5) then
        ...
        ;
        (MpCommon.AppendPersistContext)((string.lower)(l_0_5), "MasqSuspCopyTarget", 3600)
        local l_0_20 = nil
        -- DECOMPILER ERROR at PC60: Confused about usage of register: R1 in 'UnsetPending'

        TrackFileAndTechnique(l_0_5, {"T1036.003:masquerading_target", "T1036.003:defenseevasion_target", "T1036.003:MasqSuspCopy.C"})
      end
      do
        return mp.INFECTED
      end
