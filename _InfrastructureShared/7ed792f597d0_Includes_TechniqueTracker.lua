...
-- Command line: /mnt/d/out/_InfrastructureShared/7ed792f597d0_Includes_TechniqueTracker 
...
TrackPidAndTechnique(l_0_0, "T1218.005", "mshta-url")
local l_0_1 = (mp.GetProcessCommandLine)(l_0_0)
if l_0_1 == "" or l_0_1 == nil then
  return mp.CLEAN
end
local l_0_2 = (string.match)((string.lower)(l_0_1), "mshta%.?e?x?e?[\\\"]?%s[\\\"]?(https?://[^%s\\\"]+%.hta)[\\\"]?")
...
l_0_6.CONTENT_SOURCE = "MSHTA"
l_0_6.PROCESS_CONTEXT = "MSHTA.EXE"
