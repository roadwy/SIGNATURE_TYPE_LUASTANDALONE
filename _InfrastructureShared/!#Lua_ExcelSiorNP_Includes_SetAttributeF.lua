...
-- Command line: /mnt/d/out/_InfrastructureShared/!#Lua_ExcelSiorNP_Includes_SetAttributeF 

-- params : ...
-- function num : 0
local l_0_0 = (mp.get_mpattributevalue)("RPF:ExcelSiorNP:Probability")
;
(mp.set_mpattribute)("Lua:ExcelSiorML:" .. l_0_0)
do
  do
