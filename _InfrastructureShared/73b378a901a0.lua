...
-- Command line: /mnt/d/out/_InfrastructureShared/73b378a901a0 
...
do
  ...
  if not (this_sigattrlog[2]).matched or (this_sigattrlog[2]).utf8p2 == nil or (this_sigattrlog[2]).utf8p2 ~= nil then
    ...
    for l_0_8,l_0_9 in ipairs((mp.GetExecutablesFromCommandLine)((this_sigattrlog[2]).utf8p2)) do
      ...
      if (string.lower)((string.sub)(R6_PC38, -12)) ~= "rundll32.exe" and (string.lower)((string.sub)(R6_PC38, -7)) ~= "url.dll" and (sysio.IsFileExists)(R6_PC38) then
