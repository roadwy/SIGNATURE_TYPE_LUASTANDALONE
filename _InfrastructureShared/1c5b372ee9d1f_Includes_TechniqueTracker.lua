...
-- Command line: /mnt/d/out/_InfrastructureShared/1c5b372ee9d1f_Includes_TechniqueTracker 
...
if (this_sigattrlog[2]).matched and (this_sigattrlog[2]).utf8p2 ~= nil and (this_sigattrlog[3]).matched then
  ...
  for l_0_7,l_0_8 in ipairs(l_0_3) do
    ...
    if l_0_8.reason == bm.RELATIONSHIP_CREATED and (string.find)(l_0_9, l_0_1, 1, true) then
      local l_0_10 = (MpCommon.QueryPersistContext)(l_0_9, "PsExecServiceStandardName")
      if l_0_10 then
        ...
        for l_0_16,l_0_17 in ipairs(l_0_12) do
          if l_0_17.reason == bm.RELATIONSHIP_CREATED then
            ...
            TrackPidAndTechniqueBM(l_0_17.ppid, "T1021.002", "psexec_remoteservice_created_b")
          end
        end
        TrackPidAndTechniqueBM(l_0_8.ppid, "T1021.002", "remoteservice_svc_b")
        return mp.INFECTED
      end
    end
  end
