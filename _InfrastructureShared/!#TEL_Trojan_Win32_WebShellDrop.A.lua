...
-- Command line: /mnt/d/out/_InfrastructureShared/!#TEL_Trojan_Win32_WebShellDrop.A 
...
local l_0_1 = (string.lower)((string.match)((mp.get_contextdata)(mp.CONTEXT_DATA_FILENAME), "(%.[^%.]+)$"))
