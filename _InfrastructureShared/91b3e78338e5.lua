...
-- Command line: /mnt/d/out/_InfrastructureShared/91b3e78338e5 
...
do
  ...
  do
    ...
    do return l_0_8 end
    -- DECOMPILER ERROR at PC65: Confused about usage of register R4 for local variables in 'ReleaseLocals'
