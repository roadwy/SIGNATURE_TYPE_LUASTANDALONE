...
-- Command line: /mnt/d/out/_InfrastructureShared/29db392b6afcf 
      ...
      do
        ...
        do
          ...
          do
            ...
            if (string.find)(l_0_16, "\\excel.exe", 1, true) or (string.find)(l_0_16, "\\powerpnt.exe", 1, true) or (string.find)(l_0_16, "\\winword.exe", 1, true) or (string.find)(l_0_16, "\\eqnedt32.exe", 1, true) then
              return mp.INFECTED
            end
            return mp.CLEAN
          end
