...
if L0_0 then
  ...
  if L0_0 ~= nil then
    ...
    if L2_2 then
      ...
      L2_2 = L2_2.lower
      L2_2 = L2_2(L1_1)
      if string.find(L2_2, "program files", 1, true) or string.find(L2_2, ".dll", 1, true) or string.find(L2_2, ".cpl", 1, true) or string.find(L2_2, ".ocx", 1, true) or string.find(L2_2, ".tmp", 1, true) or string.find(L2_2, ".ax", 1, true) then
        return mp.CLEAN
      end
