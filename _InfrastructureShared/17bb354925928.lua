...
-- Command line: /mnt/d/out/_InfrastructureShared/17bb354925928 
...
if (this_sigattrlog[2]).matched then
  ...
  do
    ...
    -- DECOMPILER ERROR at PC172: Confused about usage of register R7 for local variables in 'ReleaseLocals'
