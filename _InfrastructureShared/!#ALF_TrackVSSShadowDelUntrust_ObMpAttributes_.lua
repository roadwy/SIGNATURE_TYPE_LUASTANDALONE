...
-- Command line: /mnt/d/out/_InfrastructureShared/!#ALF_TrackVSSShadowDelUntrust_ObMpAttributes_ 
...
l_0_4 = pcall((MpCommon.IsFriendlyProcess)(l_0_6))
if l_0_4 == true and l_0_5 == false then
