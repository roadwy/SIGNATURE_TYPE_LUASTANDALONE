...
-- Command line: /mnt/d/out/_InfrastructureShared/132b36d124e7c_Includes_TechniqueTracker,BMLuaLib 
...
if l_0_2 and not l_0_2 then
  l_0_2 = l_0_2(l_0_3, l_0_1, "")
end
if l_0_2 then
  l_0_2 = mp
  l_0_2 = l_0_2.CLEAN
