...
-- Command line: /mnt/d/out/_InfrastructureShared/192b3faa1f22e_Includes_TechniqueTracker,BMLuaLib 
...
if not contains(l_0_0, (mp.ContextualExpandEnvironmentVariables)("realtimesync.exe")) then
  return mp.CLEAN
end
do
  local l_0_2 = {}
