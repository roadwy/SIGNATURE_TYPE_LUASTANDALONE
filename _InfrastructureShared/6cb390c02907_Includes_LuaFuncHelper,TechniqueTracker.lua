...
-- Command line: /mnt/d/out/_InfrastructureShared/6cb390c02907_Includes_LuaFuncHelper,TechniqueTracker 
...
if (this_sigattrlog[2]).matched and (this_sigattrlog[2]).utf8p1 ~= nil and (this_sigattrlog[2]).utf8p2 ~= nil then
  ...
  if l_0_0 ~= l_0_1 and not StringEndsWith(l_0_1, "\\certutil.exe") then
    TrackPidAndTechniqueBM((this_sigattrlog[2]).ppid, "T1036", "masq_certutil")
    return mp.INFECTED
  end
end
do
