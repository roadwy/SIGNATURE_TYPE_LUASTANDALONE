...
if mp.readfile(pesecs[1].PointerToRawData, 64):byte(1) ~= 85 then
  return mp.CLEAN
end
if mp.readfile(pesecs[1].PointerToRawData, 64):byte(37) ~= 80 then
  return mp.CLEAN
end
if mp.readfile(pesecs[1].PointerToRawData, 64):byte(62) ~= 85 then
  return mp.CLEAN
end
return mp.INFECTED
