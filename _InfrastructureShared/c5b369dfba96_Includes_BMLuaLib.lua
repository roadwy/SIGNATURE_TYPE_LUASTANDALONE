...
if L4_4 then
  ...
  if L4_4 ~= nil then
    ...
    if L4_4 ~= nil then
      ...
      if L7_7 ~= nil and L6_6 ~= nil and L6_6 == L7_7 and L8_8 ~= nil and L5_5:match("%.[^/%.]+$") ~= nil and L5_5:match("%.[^/%.]+$") ~= L8_8 and isFileExtensionOfInterest(L5_5) and isKnownFileExtension(L4_4) == false and IsRansomwareProcessImagePathExtensionExcluded(L2_2, L8_8) == false then
