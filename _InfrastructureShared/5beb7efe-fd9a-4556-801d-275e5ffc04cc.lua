...
function L0_0()
  local L0_2, L1_3
  L0_2 = {}
  L0_2.Name = "Block execution of potentially obfuscated scripts"
  L0_2.Description = "Windows Defender Exploit Guard detected either obfuscated JavaScript, VBScript, or macro code."
