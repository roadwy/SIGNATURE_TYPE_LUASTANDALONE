  ...
  if not L1_1 then
    ...
    if not L1_1 then
      ...
      if not L1_1 then
        ...
        L2_2 = L2_2.lower
        L2_2 = L2_2(L0_0)
        L1_1 = L1_1(L2_2, "torrent.exe", 1, true)
        if not L1_1 then
          L1_1 = string
          L1_1 = L1_1.find
          L2_2 = string
          ...
          if not L1_1 then
            ...
            L2_2 = L2_2.lower
            L2_2 = L2_2(L0_0)
            L1_1 = L1_1(L2_2, "atmgr.exe", 1, true)
            if not L1_1 then
              L1_1 = string
              L1_1 = L1_1.find
              L2_2 = string
              L2_2 = L2_2.lower
              L2_2 = L2_2(L0_0)
              L1_1 = L1_1(L2_2, "java.exe", 1, true)
              if not L1_1 then
                L1_1 = string
                L1_1 = L1_1.find
                L2_2 = string
                L2_2 = L2_2.lower
                L2_2 = L2_2(L0_0)
                L1_1 = L1_1(L2_2, "photoshop.exe", 1, true)
                if not L1_1 then
                  L1_1 = string
                  L1_1 = L1_1.find
                  L2_2 = string
                  L2_2 = L2_2.lower
                  L2_2 = L2_2(L0_0)
                  L1_1 = L1_1(L2_2, "geforcenowstreamer.exe", 1, true)
                  if not L1_1 then
                    L1_1 = string
                    L1_1 = L1_1.find
                    L2_2 = string
                    L2_2 = L2_2.lower
                    L2_2 = L2_2(L0_0)
                    L1_1 = L1_1(L2_2, "bomgar-scc.exe", 1, true)
                    if not L1_1 then
                      L1_1 = string
                      L1_1 = L1_1.find
                      L2_2 = string
                      L2_2 = L2_2.lower
                      L2_2 = L2_2(L0_0)
                      L1_1 = L1_1(L2_2, "bomgar-rep.exe", 1, true)
                      if not L1_1 then
                        L1_1 = string
                        L1_1 = L1_1.find
                        L2_2 = string
                        L2_2 = L2_2.lower
                        L2_2 = L2_2(L0_0)
                        L1_1 = L1_1(L2_2, "l2dotnetlauncher.exe", 1, true)
                        if not L1_1 then
                          L1_1 = string
                          L1_1 = L1_1.find
                          L2_2 = string
