...
-- Command line: /mnt/d/out/_InfrastructureShared/!#Lua_amsiV2JamsiMpAttributeML_Includes_SetAttributeF 

-- params : ...
-- function num : 0
local l_0_0 = (mp.get_mpattributevalue)("RPF:AMSI2:ML:Jamsi")
do
  do
    if l_0_0 ~= nil then
      local l_0_1 = {}
