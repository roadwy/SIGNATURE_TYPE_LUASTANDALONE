...
if L10_10 then
  ...
  if #L10_10 == 5 then
    MpCommon.BmTriggerSig(L1_1, "BM_GenRansomNoteTrackerGenC", safeJsonSerialize(L10_10))
    mp.set_mpattribute("Lua:RansomNoteTracker.Gen")
    extractRansomNote(L2_2 .. "\\" .. L3_3)
    return mp.INFECTED
  end
else
  AppendToRollingQueue(L5_5, L9_9, L2_2, L6_6, L7_7, 0)
