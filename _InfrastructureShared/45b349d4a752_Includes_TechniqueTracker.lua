...
if string.find(L1_1, "\\program files", 1, true) or string.find(L1_1, "\\netlogon\\", 1, true) or string.find(L1_1, "\\sysvol\\", 1, true) or string.find(L1_1, "\\fidelity", 1, true) or string.find(L1_1, "\\dslogon\\", 1, true) or string.find(L1_1, "\\opmanager\\", 1, true) or string.find(L1_1, "/nologo ", 1, true) then
  return mp.CLEAN
end
