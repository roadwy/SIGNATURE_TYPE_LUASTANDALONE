...
-- Command line: /mnt/d/out/_InfrastructureShared/91b307051d85_Includes_BMLuaLib 
...
do
  ...
  if l_0_0 ~= nil then
    local l_0_2 = nil
    for l_0_6,l_0_7 in ipairs((string.lower)((mp.GetExecutablesFromCommandLine)(l_0_0))) do
      local l_0_3 = nil
