...
-- Command line: /mnt/d/out/_InfrastructureShared/d5b3742375af_Includes_TechniqueTracker,LuaFuncHelper 
...
if l_0_1 ~= nil and l_0_2 ~= nil then
  ...
  for l_0_7,l_0_8 in ipairs(l_0_3) do
    ...
    local l_0_10, l_0_11 = pcall(MpCommon.QueryPersistContext, l_0_9, "SuspExeFileDroppedBySystemProcess")
    if l_0_10 ~= nil and l_0_11 then
      (bm.trigger_sig)("T1570", "exec_remotedroppedscript_a", l_0_2)
      return mp.INFECTED
    end
    if IsKeyInRollingQueue("DroppedByPossibleRemotelyCreatedProc", l_0_9) then
