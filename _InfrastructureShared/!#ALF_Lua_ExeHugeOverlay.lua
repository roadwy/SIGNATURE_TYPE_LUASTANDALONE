...
if L2_2 <= 196608 and L2_2 >= 36864 then
  L3_3 = pesecs
  L3_3 = L3_3[L1_1]
  L3_3 = L3_3.PointerToRawData
  L4_4 = pesecs
  L4_4 = L4_4[L1_1]
  L4_4 = L4_4.SizeOfRawData
  L3_3 = L3_3 + L4_4
  L4_4 = L0_0 - L3_3
  if L4_4 > 208666624 then
    L5_5 = mp
    L5_5 = L5_5.CLEAN
    return L5_5
  end
  if L4_4 < 51380224 then
    L5_5 = mp
    L5_5 = L5_5.CLEAN
    return L5_5
  end
  ...
  L5_5 = L5_5("MpAPILimitReached")
  if not L5_5 then
    L5_5 = mp
    L5_5 = L5_5.get_mpattribute
    L5_5 = L5_5("MpHasExpensiveLoop")
    if not L5_5 then
      L5_5 = peattributes
      L5_5 = L5_5.dt_error_not_enough_memory
      if not L5_5 then
        L5_5 = peattributes
        L5_5 = L5_5.dt_error_heur_exit_criteria
        if not L5_5 then
          L5_5 = peattributes
          L5_5 = L5_5.executes_from_dynamic_memory
        end
      end
    end
  elseif L5_5 then
