...
L0_0 = L0_0()
if L0_0 <= 300 or L0_0 > 800000 then
  L1_1 = mp
  L1_1 = L1_1.CLEAN
  return L1_1
end
...
L1_1 = L1_1(L2_2, L2_2(mp.bitor(mp.FILEPATH_QUERY_FULL, mp.FILEPATH_QUERY_LOWERCASE)))
L2_2 = string
L2_2 = L2_2.lower
L2_2 = L2_2(mp.get_contextdata(mp.CONTEXT_DATA_FILENAME))
if string.sub(L2_2, -3) ~= ".js" and string.sub(L2_2, -4) ~= ".jse" and string.sub(L2_2, -4) ~= ".vbs" and string.sub(L2_2, -4) ~= ".vbe" and string.sub(L2_2, -4) ~= ".wsf" then
  return mp.CLEAN
end
if L1_1 == nil then
  return mp.CLEAN
...
if L2_2:match("%->.+/") or L2_2:match("%->.+\\") or L2_2:match("%->.+%->") then
  return mp.CLEAN
end
