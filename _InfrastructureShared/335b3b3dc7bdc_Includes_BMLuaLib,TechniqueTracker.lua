...
-- Command line: /mnt/d/out/_InfrastructureShared/335b3b3dc7bdc_Includes_BMLuaLib,TechniqueTracker 
    ...
    if (sigattr_tail[l_0_12]).attribute == 16386 then
      ...
      if l_0_1[l_0_15] ~= nil and l_0_8[l_0_16] == nil then
        ...
        if l_0_17 ~= nil then
          ...
          if (l_0_18 == 1 or l_0_18 == 2 or l_0_17 == ".pdf") and #l_0_14 < #l_0_13 and l_0_13:find(l_0_14, 1, true) == 1 and l_0_13:byte(#l_0_14 + 1) ~= 58 then
            l_0_8[l_0_16] = 1
            ...
            if (mp.GetExtensionClass)(l_0_19) ~= 4 then
              ...
              if l_0_7[l_0_20] ~= nil then
                ...
                if #l_0_7[l_0_20] >= 5 then
                  ...
                  -- DECOMPILER ERROR at PC199: Overwrote pending register: R19 in 'AssignReg'
                  ...
                  if (bm.get_current_process_startup_info)() ~= nil then
                    do
                      ...
                      -- DECOMPILER ERROR at PC208: Confused about usage of register: R19 in 'UnsetPending'
                      ...
                      for l_0_39,l_0_40 in pairs(l_0_7[l_0_20]) do
                        ...
                        -- DECOMPILER ERROR at PC221: Confused about usage of register: R25 in 'UnsetPending'

                        do
                          local l_0_42, l_0_43, l_0_44 = , (string.find)((sigattr_tail[4]).utf8p1, "\\[^\\]*$") or 0
                          -- DECOMPILER ERROR at PC233: Confused about usage of register: R26 in 'UnsetPending'

                          -- DECOMPILER ERROR at PC235: Confused about usage of register: R27 in 'UnsetPending'

                          local l_0_45 = nil
                          -- DECOMPILER ERROR at PC243: Confused about usage of register: R27 in 'UnsetPending'
                          ...
                          do
                            ...
                            -- DECOMPILER ERROR at PC288: Confused about usage of register: R27 in 'UnsetPending'
                            ...
                            do
                              do
                                if (string.find)(l_0_45, ".", (string.find)(l_0_45, "\\[^\\]*$") or 0, true) ~= nil then
                                  ...
                                  -- DECOMPILER ERROR at PC305: Confused about usage of register: R28 in 'UnsetPending'

                                  l_0_36 = l_0_36 .. ";" .. (string.sub)(l_0_45, (string.find)(l_0_45, ".", (string.find)(l_0_45, "\\[^\\]*$") or 0, true) + 1) .. ";"
                                end
                                ;
                                (bm.add_related_file)((sigattr_tail[l_0_41]).utf8p1)
                                ;
                                (bm.add_related_file)((sigattr_tail[l_0_41]).utf8p2)
                                ;
                      ...
                      do
                        ...
                        for l_0_53,l_0_54 in ipairs(l_0_49) do
                          ...
                          -- DECOMPILER ERROR at PC349: Confused about usage of register: R27 in 'UnsetPending'
                        ...
                        for l_0_58,l_0_59 in ipairs(l_0_50) do
                          local l_0_55 = nil
                          -- DECOMPILER ERROR at PC357: Confused about usage of register: R27 in 'UnsetPending'

                          -- DECOMPILER ERROR at PC362: Confused about usage of register: R27 in 'UnsetPending'
                        ...
                        ;
                        (MpCommon.OverwritePersistContextNoPath)("genb2_ransom_meta", l_0_28, 700)
                        ;
                        (bm.trigger_sig)("GenericRansomware", "Type2.2")
                        sms_untrusted_process()
                        ;
                        (bm.add_action)("SmsAsyncScanEvent", 100)
                        TrackPidAndTechniqueBM(l_0_35, "T1486", "susp_ransmware_type2")
                        reportTimingData()
                        do return mp.INFECTED end
                        do
                          local l_0_60 = {}
                          -- DECOMPILER ERROR at PC409: No list found for R16 , SetList fails

                          -- DECOMPILER ERROR at PC411: LeaveBlock: unexpected jumping out DO_STMT

                          -- DECOMPILER ERROR at PC411: LeaveBlock: unexpected jumping out DO_STMT

                          -- DECOMPILER ERROR at PC411: LeaveBlock: unexpected jumping out IF_THEN_STMT
